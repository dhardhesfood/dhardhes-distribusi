...
<div class="py-6 px-6 max-w-7xl mx-auto">
    ...
    {{-- REKAP GLOBAL PER PRODUK (BERDASARKAN FILTER YANG TAMPIL) --}}
    @php
        $globalProducts = [];
    ...
    <div class="md:hidden space-y-4">
        ...
        <div class="bg-white shadow rounded p-4">
            ...
            <div class="text-sm mb-2">
                <div class="font-semibold mb-1">Detail Produk:</div>
                @if(count($store['products']) > 0)
                    <ul class="space-y-1">
                        @foreach($store['products'] as $product)
                            <li class="flex justify-between">
                ...
                @else
                    <div class="text-gray-400 text-xs">Tidak ada stok</div>
                @endif
            </div>
