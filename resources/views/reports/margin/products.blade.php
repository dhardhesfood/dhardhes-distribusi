...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
    ...
    <div style="background:white;padding:20px;border-radius:16px;box-shadow:0 10px 20px rgba(0,0,0,0.08);">
        <form method="GET" action="{{ route('reports.margin.products') }}" style="display:flex;gap:20px;align-items:end;flex-wrap:wrap;">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
            <thead style="background:#f3f4f6;">
                <tr>
                    ...
                    <th style="padding:12px;text-align:right;">Qty Terjual</th>
